...
export default function Privacy() {
	return (
		<Flex flexDir={"column"} p={10} textAlign={"justify"} color={"#eee"}>
			<Heading my="3" size={"2xl"} id="-night-watch-privacy-policy-">
				<strong>NIGHT WATCH PRIVACY POLICY</strong>
			</Heading>
			<p>
				THIS PRIVACY POLICY DESCRIBES HOW YOUR PERSONAL INFORMATION IS
				COLLECTED, USED, AND SHARED WHEN YOU VISIT OR MAKE A PURCHASE FROM
				WWW.IMPOSSIBLETRIOS.ART (THE “SITE”).
			</p>
			<Heading
				as="h2"
				my="3"
			...
			<p>
				...
				EMAIL ADDRESS, METAMASK, ETH ADDRESS AND PHONE NUMBER.) WE REFER TO THIS
			...
			<p>
				...
				ACQUISITION, CONSOLIDATION, RESTRUCTURING, THE SALE OF SUBSTANTIALLY ALL
				OF OUR SHARES AND/OR ASSETS, IN CONNECTION WITH BANKRUPTCY PROCEEDINGS,
				REORGANIZATION, OR OTHER CHANGE OF CONTROL EVENTS.
			</p>
			<p>
			...
			<Heading as="h2" my="3" fontSize="xl" id="-behavioral-advertising-">
			...
			<p>
				GOOGLE - HTTPS://WWW.GOOGLE.COM/SETTINGS/ADS/ANONYMOUS ADDITIONALLY, YOU
				CAN OPT OUT OF SOME OF THESE SERVICES BY VISITING THE DIGITAL
				ADVERTISING ALLIANCE’S OPT-OUT PORTAL AT: HTTP://OPTOUT.ABOUTADS.INFO/.
			</p>
			<Heading as="h2" my="3" fontSize="xl" id="-do-not-track-">
			...
			<Heading as="h2" my="3" fontSize="xl" id="-your-rights-">
			...
			<Heading as="h2" my="3" fontSize="xl" id="-data-retention-">
			...
			<Heading as="h2" my="3" fontSize="xl" id="-minors-">
				<strong>MINORS</strong>
			</Heading>
			<p>THE SITE IS NOT INTENDED FOR INDIVIDUALS UNDER THE AGE OF 18.</p>
			<Heading as="h2" my="3" fontSize="xl" id="-changes-">
